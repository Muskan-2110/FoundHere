...
try {
    ...
    $mail->addAddress($requester_mail);               //Name is optional
    ...
    $mail->Body    = 'Hi, we are from foundhere team ,the document that you lost has been found by someone .Here we are giving you the E-mail ID of respective person kindly interact with the person who find it.The E-mail ID is '.$email.' ';
